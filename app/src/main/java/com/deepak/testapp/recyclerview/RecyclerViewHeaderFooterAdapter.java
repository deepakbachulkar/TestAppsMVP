...
//                    mUpdater.update(position);
    ...
    public void addFooter(View footer)
    {
        if(!mFooters.contains(footer)){
            mFooters.add(footer);
            //animate
            notifyItemInserted(mIntermediary.getItemCount()+ mFooters.size()-1);
        }
    }
    ...
    public void setIntermediary(IRecyclerViewIntermediary intermediary)
    {
